...
async function writeExifImg2 (media, metadata) {
    ...
    if (metadata.packname || metadata.author) {
        ...
        const json = { "sticker-pack-id": `YOS FÊNIX`, "sticker-pack-name": metadata.packname, "sticker-pack-publisher": metadata.author, "emojis": metadata.categories ? metadata.categories : [""] }
...
async function sendImageAsSticker2(yosFenixBot, from, buffer, quoted, metadata = {}) {
    try {
        const packname = metadata.packname || "YOS FÊNIX"
        const author = metadata.author || "YOS FÊNIX"
        ...
        await yosFenixBot.sendMessage(from, { sticker: finalBuffer }, { quoted })
...
async function sendVideoAsSticker2(yosFenixBot, from, buffer, quoted, metadata = {}) {
    try {
        const packname = metadata.packname || "YOS FÊNIX"
        const author = metadata.author || "YOS FÊNIX"
