//YOS FÊNIX - Função de upload para imgbb V2
const axios = require('axios')
const FormData = require('form-data')
const crypto = require('crypto')
const { fromBuffer } = require('file-type')

const YosFenixUserAgent = () => "Mozilla/5.0 (Windows NT 10.0; Win64; x64)"
async function YosFenixUpload(buffer) {
...
module.exports = YosFenixUpload //YOS FÊNIX