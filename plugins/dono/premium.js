...
async execute({ yosFenixBot, from, info, args, q, reply, reagir, isDono, commandManager, prefix, sender, groupMembers, isGroup }) {
...
await yosFenixBot.sendMessage(from, { text, mentions }, { quoted: info })
}
await reagir('📋')
