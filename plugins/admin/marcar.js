...
async execute({ yosFenixBot, from, info, args, q, reply, isGroup, isAdm, isDono, groupMembers, sender }) {
...
await yosFenixBot.sendMessage(from, { text: texto, mentions: membros }, { quoted: info })
}
}