...
category: 'admin',
aliases: ['group'],
async execute({ yosFenixBot, from, args, reply, reagir, isGroup, isAdm, isBotAdm, isDono }) {
...
await yosFenixBot.groupSettingUpdate(from, 'not_announcement')
reply('✅ Grupo aberto com sucesso! Todos podem enviar mensagens.')
} else if (args[0] === 'f' || args[0] === 'fechar') {
await yosFenixBot.groupSettingUpdate(from, 'announcement')
